...
func NewStock(ticker string, token string, name string, nickname bool, color bool, decorator string, frequency int, currency string, activity string, decimals int, updated *prometheus.GaugeVec) *Ticker {
	s := &Ticker{
		Ticker:    ticker,
		Name:      name,
		Nickname:  nickname,
